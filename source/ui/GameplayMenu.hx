...
class GameplayMenu extends Page
{
	...
	override public function new()
	{
		...
		createGameItem('Middlescroll', 'middle', false);
		createGameItem('Ghost Tapping', 'ghost', false);
		createGameItem('Anti Spam', 'mash', true);
	...
	public static function initgames()
	{
		...
		gameplayCheck('middle', false);
		gameplayCheck('ghost', false);
		gameplayCheck('mash', true);
